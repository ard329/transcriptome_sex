...
resid_exp = readRDS(file="residual_expression.rds")
...
write.csv(pleioT, "pleiotropy_per_gene.csv")
saveRDS(pleioT, file = "tissue_specificity_per_gene.rds")

## plot tissue specificity ~ sex differences in expression

pleioT = readRDS(file = "tissue_specificity_per_gene.rds")
